...
public class BasicIgnisCollectorScreen extends ContainerScreen<BasicIgnisCollectorContainer> {

    private final ResourceLocation GUI = new ResourceLocation(MakingMagic.MOD_ID, "textures/gui/basic_collector.png");

    public BasicIgnisCollectorScreen(BasicIgnisCollectorContainer screenContainer, PlayerInventory playerInventory, ITextComponent titleIn) {
