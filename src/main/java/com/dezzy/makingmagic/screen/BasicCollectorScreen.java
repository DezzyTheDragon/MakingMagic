...
public class BasicCollectorScreen extends ContainerScreen<BasicCollectorContainer> {
    private final ResourceLocation GUI = new ResourceLocation(MakingMagic.MOD_ID, "textures/gui/basic_collector.png");

    public BasicCollectorScreen(BasicCollectorContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
