...
public class BasicTerraCollectorScreen extends ContainerScreen<BasicTerraCollectorContainer> {

    private final ResourceLocation GUI = new ResourceLocation(MakingMagic.MOD_ID, "textures/gui/basic_collector.png");

    public BasicTerraCollectorScreen(BasicTerraCollectorContainer screenContainer, PlayerInventory pInventory, ITextComponent titleIn) {
