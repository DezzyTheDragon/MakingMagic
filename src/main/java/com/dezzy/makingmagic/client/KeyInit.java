...
public class KeyInit {
    ...
    public static void init() {
        testKey = registerKey("testkey", 82, "key.makingmagic.keycat");
    }

    private static KeyBinding registerKey(String desc, int keycode, String cat) {
        KeyBinding key = new KeyBinding("key.makingmagic." + desc, keycode, cat);
