...
public class BasicAquaCollectorContainer extends Container {

    private final TileEntity tileEntity;
    private final PlayerEntity playerEntity;
    private final IItemHandler playerInventory;

    public BasicAquaCollectorContainer(int windowId, World world, BlockPos pos, PlayerInventory pInventory, PlayerEntity player) {
        super(MakingMagicContainer.BASIC_AQUA_COLLECTOR_CONTAINER.get(), windowId);
    ...
    public boolean canInteractWith(PlayerEntity playerIn) {
        return isWithinUsableDistance(IWorldPosCallable.of(tileEntity.getWorld(), tileEntity.getPos()), playerIn, MakingMagicBlocks.BASIC_AQUA_COLLECTOR.get());
    }
