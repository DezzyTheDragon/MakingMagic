...
public class BasicIgnisCollectorContainer extends Container {

    private final TileEntity tileEntity;
    private final PlayerEntity playerEntity;
    private final IItemHandler playerInventory;

    public BasicIgnisCollectorContainer(int windowId, World world, BlockPos pos, PlayerInventory pInventory, PlayerEntity player) {
        super(MakingMagicContainer.BASIC_IGNIS_COLLECTOR_CONTAINER.get(), windowId);
    ...
    public boolean canInteractWith(PlayerEntity playerIn) {
        return isWithinUsableDistance(IWorldPosCallable.of(tileEntity.getWorld(), tileEntity.getPos()), playerIn, MakingMagicBlocks.BASIC_IGNIS_COLLECTOR.get());
    }
